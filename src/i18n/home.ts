...
const en: HomeDict = {
  ...
  hero: {
    ...
    h1a: "Industrial Floor Scrubbers & Sweepers",
    h1b: "Manufacturer",
    h1c: "Factory Direct",
    sub: "Aikerui is a verified industrial floor scrubber and sweeper manufacturer with our own factory in Anhui, China. Factory-direct pricing, custom OEM, CE & ISO 9001 — plus replacement brushes and parts for all major brands.",
    cta: "Get Factory Price",
    assurance: "24-Hour Quote Response — Engineer-Level Support",
  },
  categories: { kicker: "Our Products", title: "Manufactured In-House, Shipped Worldwide", sub: "Every machine is designed, manufactured, and tested in our Anqing facility before export.", products: "products" },
...
const es: HomeDict = {
  ...
  hero: {
    ...
    h1a: "Fregadoras y Barredoras Industriales",
    h1b: "Fabricante",
    h1c: "Directo de Fábrica",
    sub: "Aikerui es un fabricante verificado de fregadoras y barredoras industriales con fábrica propia en Anhui, China. Precio directo de fábrica, OEM personalizado, CE e ISO 9001 — además de repuestos para todas las marcas.",
    cta: "Obtener Precio de Fábrica",
    assurance: "Respuesta en 24 Horas — Soporte Técnico",
  },
  categories: { kicker: "Nuestros Productos", title: "Fabricación propia, envío a todo el mundo", sub: "Cada máquina se diseña, fabrica y prueba en nuestras instalaciones de Anqing antes de la exportación.", products: "productos" },
...
const ar: HomeDict = {
  ...
  hero: {
    ...
    h1a: "ماكينات تنظيف الأرضيات الصناعية",
    h1b: "مصنّع",
    h1c: "مباشرة من المصنع",
    sub: "أيكيروي مصنّع موثوق لماكينات تنظيف الأرضيات الصناعية مع مصنعه الخاص في أنهوي بالصين. أسعار مباشرة من المصنع، تصنيع OEM مخصص، شهادات CE وISO 9001 — بالإضافة إلى قطع غيار لجميع الماركات.",
    cta: "احصل على سعر المصنع",
    assurance: "رد على العرض خلال 24 ساعة — دعم فني من المهندسين",
  },
  categories: { kicker: "منتجاتنا", title: "تصنيع داخلي، شحن عالمي", sub: "كل ماكينة تُصمم وتُصنع وتُختبر في منشأتنا في أنهوي قبل التصدير.", products: "منتج" },
...
const ru: HomeDict = {
  ...
  hero: {
    ...
    h1a: "Промышленные поломоечные машины",
    h1b: "Производитель",
    h1c: "Напрямую с завода",
    sub: "Aikerui — проверенный производитель промышленных поломоечных машин с собственным заводом в Аньхой, Китай. Цены напрямую с завода, индивидуальный OEM, сертификаты CE и ISO 9001 — а также запчасти для всех брендов.",
    cta: "Получить заводскую цену",
    assurance: "Ответ в течение 24 часов — поддержка инженеров",
  },
  categories: { kicker: "Наша продукция", title: "Собственное производство, доставка по всему миру", sub: "Каждая машина проектируется, производится и тестируется на нашем предприятии в Аньхой перед экспортом.", products: "товаров" },
...
const fr: HomeDict = {
  ...
  hero: {
    ...
    h1a: "Autolaveuses Industrielles",
    h1b: "Fabricant",
    h1c: "Direct Usine",
    sub: "Aikerui est un fabricant vérifié d'autolaveuses industrielles avec sa propre usine dans l'Anhui, en Chine. Prix direct usine, OEM personnalisé, CE et ISO 9001 — ainsi que des pièces pour toutes les marques.",
    cta: "Obtenir le Prix Usine",
    assurance: "Réponse en 24 Heures — Support Technique",
  },
  categories: { kicker: "Nos Produits", title: "Fabrication en interne, expédition dans le monde entier", sub: "Chaque machine est conçue, fabriquée et testée dans notre site d'Anqing avant exportation.", products: "produits" },
