/**
 * Lightweight inline SVG icons — replaces lucide-react bundle.
 * Each icon is a minimal React component with size + className props.
 * Total size: ~3KB uncompressed vs lucide-react ~20KB+ min+gzip.
 */

type IconProps = { size?: number; className?: string };

function createIcon(path: string, viewBox = "24 24") {
...
export const Truck = createIcon(
  '<path d="M5 17H3V4h13v13h-2"/><path d="M16 9h3l3 3v5h-2"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/>'
);
