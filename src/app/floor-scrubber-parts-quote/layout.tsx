...
export const metadata: Metadata = {
  title: "Floor Scrubber Replacement Parts | Disc Brushes & Squeegees | Factory Direct | Aikerui",
  description:
    "Factory-direct floor scrubber parts & consumables. Disc brushes, squeegee rubber, pad holders — 30-50% less than dealer prices. Compatible with Tennant, Nilfisk, Karcher. 360+ parts in stock, quote within 24h.",
  keywords: [
