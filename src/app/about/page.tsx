...
export const metadata: Metadata = {
  ...
  description:
    "Visit Aikerui's 10,000+㎡ factory in Anqing, China. ISO 9001 & CE certified floor scrubber manufacturer. Video tours welcome. Serving 50+ countries.",
  alternates: { canonical: "https://aikeruiclean.com/about" },
};

const factoryImages = [
  { src: "/images/factory-opt/1.webp", alt: "Aikerui factory entrance - real manufacturer", label: "Factory Entrance" },
  { src: "/images/factory-opt/2.webp", alt: "Aikerui production line", label: "Production Workshop" },
  { src: "/images/factory-opt/3.webp", alt: "Aikerui assembly line", label: "Assembly Line" },
  { src: "/images/factory-opt/5.webp", alt: "Aikerui quality control", label: "Quality Control" },
  { src: "/images/factory-opt/_MG_3280.webp", alt: "Aikerui CNC workshop", label: "CNC Workshop" },
  { src: "/images/factory-opt/_MG_3285.webp", alt: "Aikerui warehouse", label: "Warehouse & Inventory" },
];
  ...
  return (
    <div>
      ...
      <section className="relative h-[60vh] min-h-[400px] max-h-[600px] overflow-hidden">
        <Image src="/images/factory-opt/_MG_3302.webp" alt="Aikerui real factory" fill className="object-cover" sizes="100vw" priority />
